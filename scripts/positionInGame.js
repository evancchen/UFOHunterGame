...
InGamePosition.prototype.update = function (play) {
    ...
    for (let i = 0; i < this.ufos.length; i++) {
        let ufo = this.ufos[i];
        let fresh_x = ufo.x + this.ufoSpeed * upSec * this.turnAround * this.horizantalMoving;
...
InGamePosition.prototype.entry = function (play) {
    ...
    this.bombSpeed = this.setting.ufoSpeed + (presentLevel * 10);
...
InGamePosition.prototype.draw = function (play) {
    ...
    ctx.fillStyle = "#425252"
    ctx.textAlign = "left";
    ctx.fillText("Press S to swtich sound effects ON/OFF.  Sound:", play.playBoundaries.left, play.playBoundaries.bottom + 70);
